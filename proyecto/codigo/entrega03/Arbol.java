...
public class Arbol {
    ...
    /**
        ...
        * @param rows que corresponde a los estudiantes del dataset de test
    ...
    */
    ...
    /**
        ...
        * @param rows que corresponde a los estudiantes que tiene el nodo
        * @param question que corresponde a la pregunta con la cual se va dividir el nodo
    ...
    */
    public ArrayList find_best_split(ArrayList<ArrayList<String>> rows){
        ...
        for(int col = 0; col<n_features-1; col++){
            ...
            for (ArrayList<String> row : rows) {  
                ...
                if (!values.containsKey(row.get(col))) {
                    values.put((String)row.get(col),col);
                }
            }
        }
        ...
        for(String val : values.keySet()){
         ...
         //System.out.println(val+ " col: "+col);
          ...
          Question question = new Question(values.get(val), val);
    ...
    /**
        ...
        * @param node que corresponde a raiz del árbol
    */
    ...
    /**
        ...
        * @param root que corresponde a raiz del árbol
    */
    ...
    /**
        * Metodo auxiliar para imprimir el árbol
        * @param node que corresponde a raiz del árbol
        * @param row que corresponde a el estudiante que se queire clasificar
